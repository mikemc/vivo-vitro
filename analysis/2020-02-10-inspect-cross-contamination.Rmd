...
plot_grid(p1, p2)
ggsave(
  here("results/figures", "2020-02-10-t-mobilis-contam-histogram.pdf"),
  width = 8,
  height = 4
)
```
...
ggsave(
  here("results/figures", "2020-02-10-plate-layout.pdf"),
  width = 8,
  height = 6
)
```
...
ggsave(
  here("results/figures", "2020-02-10-t-mobilis-contam-across-plate.pdf"),
  width = 8,
  height = 6
)
```
...
```{r}
ggsave(
  here("results/figures", "2020-02-10-zymo-contam-across-plate.pdf"),
  width = 8,
  height = 6
)
```
